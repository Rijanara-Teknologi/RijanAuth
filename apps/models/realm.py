...
class Realm(BaseModel):
    ...
    def to_dict(self):
        ...
        return {
            ...
            'accessTokenLifespanForImplicitFlow': self.access_token_lifespan_for_implicit_flow,
            ...
            'accessCodeLifespan': self.access_code_lifespan,
            'accessCodeLifespanUserAction': self.access_code_lifespan_user_action,
            'accessCodeLifespanLogin': self.access_code_lifespan_login,
            'waitIncrementSeconds': self.wait_increment_seconds,
            'maxLoginFailures': self.max_login_failures,
